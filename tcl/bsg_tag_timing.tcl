...
proc bsg_tag_add_client_cdc_timing_constraints { bsg_tag_clk_name other_clk_name } {
    ...
    puts "ADDING BSG TAG CDC CONSTRAINTS..."
    ...
    set bsg_tag_period  [get_db [get_clocks $bsg_tag_clk_name] .period]
    set other_period [get_db [get_clocks $other_clk_name] .period]

    puts "Tag clock '${bsg_tag_clk_name}' period: ${bsg_tag_period}"
    ...
    if {[sizeof_collection [get_clocks $bsg_tag_clk_name_cdc]]==0} {
        ...
        create_clock -name $bsg_tag_clk_name_cdc \
            ...
            -add [get_port [get_db [get_clocks $bsg_tag_clk_name] .sources]]
    }

    create_clock -name $other_clk_name_cdc \
        -period $other_period \
        -add [get_port [get_db  [get_clocks $other_clk_name] .sources]]
